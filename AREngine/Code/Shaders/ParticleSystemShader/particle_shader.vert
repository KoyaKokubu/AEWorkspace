...
void main() {	
	...
	//	+ gl_PointSize * inPosition.x * cameraRightWorld
	//	+ gl_PointSize * inPosition.y * cameraUpWorld;
	//vec3 positionWorld = PointCloud.particlesIn[gl_InstanceIndex].position.xyz
	//gl_Position = ubo.projection * ubo.view * vec4(positionWorld, 1.0);
	//fragColor = vec4(inPosition.x, inPosition.y, 1.0, 1.0); // PointCloud.particlesIn[gl_InstanceIndex].color;
}